...
const copy = {
  en: {
    ...
    eyebrow: 'Game production GPT-Image2 prompt lab',
    ...
    templateSubtitle:
      'Each template is tuned for handoff: downstream owner, asset purpose, output format, slicing/import constraints, readability checks, and common failure modes.',
    templateKind: 'Prompt Template',
    openTemplate: 'Open Template',
    skillEyebrow: 'Agent skill',
    skillTitle: 'Bring the GPT-Image2 game production library into Claude Code and Codex.',
    skillSubtitle:
      'Install one skill, then let your agent choose deliverable templates, production tags, downstream handoff contexts, and pitfalls from the same library behind this site.',
    skillCommandLabel: 'Install for local agents',
    skillPromptLabel: 'Try this request',
    skillPrompt: 'Use gpt-image-2-game-style-library to create a production prompt for a mobile RPG UI panel slicing sheet.',
  ...
  zh: {
    ...
    eyebrow: '面向游戏研发交付的 GPT-Image2 提示词工作台',
    ...
    templateSubtitle:
      '每套模板都面向研发交付，包含下游使用者、资产用途、输出规格、切图/导入约束、可读性验收和常见翻车点。',
    templateKind: '提示词模板',
    openTemplate: '打开模板',
    skillEyebrow: 'Agent Skill',
    skillTitle: '把 GPT-Image2 游戏研发提示词库装进 Claude Code 和 Codex。',
    skillSubtitle:
      '安装一个 skill，让 Agent 从本站同源的研发交付模板、生产标签、下游场景和防坑规则里自动选型，直接输出可复制的 GPT Image 2 prompt。',
    skillCommandLabel: '安装到本地 Agent',
    skillPromptLabel: '试试这个请求',
    skillPrompt: '用 gpt-image-2-game-style-library 技能生成手游 RPG UI 面板切图表 Prompt',
